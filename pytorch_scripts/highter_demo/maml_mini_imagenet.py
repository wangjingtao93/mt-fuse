...
def main():
    ...
    for epoch in range(100):
        db_train = DataLoader(mini, args.task_num, shuffle=True, num_workers=0, pin_memory=True)
        train(db_train, net, device, meta_opt, epoch, log)

        db_test = DataLoader(mini_test, args.task_num, shuffle=True, num_workers=0, pin_memory=True)

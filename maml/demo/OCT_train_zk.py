...
def main():
    ...
    mini = OCTImage('D:/workplace/python/data/meta-oct/', mode='train', n_way=args.n_way, k_shot=args.k_spt,
                        k_query=args.k_qry,
                        batchsz=300, resize=args.imgsz)
    mini_test = OCTImage('D:/workplace/python/data/meta-oct/', mode='test', n_way=args.n_way, k_shot=args.k_spt,
                             k_query=args.k_qry,
